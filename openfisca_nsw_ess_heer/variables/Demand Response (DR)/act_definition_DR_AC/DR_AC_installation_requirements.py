...
class DR_AC_is_installed_in_residential_building(Variable):
    value_type = bool
    entity = Building
...
class DR_AC_installation_requirements_are_met(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        installed_in_residential = buildings('DR_AC_is_installed_in_residential_buildings', period)
