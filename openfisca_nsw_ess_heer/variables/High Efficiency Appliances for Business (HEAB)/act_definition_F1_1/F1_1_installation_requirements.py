...
class F1_1_is_installed(Variable):
    value_type = bool
    entity = Building
...
class F1_1_is_operating(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F1_1_meets_installation_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        is_installed = buildings('F1_1_is_installed', period)
        in_intended_place_of_use = buildings('F1_1_is_in_intended_place_of_use', period)
        is_operating = buildings('F1_1_is_operating', period)
