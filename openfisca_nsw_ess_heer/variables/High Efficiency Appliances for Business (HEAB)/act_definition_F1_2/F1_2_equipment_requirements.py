...
class F1_2_is_integral_RDC(Variable):
    value_type = bool
    entity = Building
...
class F1_2_is_registered_in_GEMS_2012(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F1_2_is_registered_in_GEMS_2019(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    label = 'Is the End User Equipment a registered product based on Greenhouse' \
...
class F1_2_annual_energy_consumption_below_baseline_EEI(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class F1_2_annual_energy_consumption(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class F1_2_meets_all_equipment_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        is_integral_RDC = buildings('F1_2_is_integral_RDC', period)
        registered_in_GEMS_2012 = buildings('F1_2_is_registered_in_GEMS_2012', period)
        registered_in_GEMS_2019 = buildings('F1_2_is_registered_in_GEMS_2019', period)
        below_baseline_EEI = buildings('F1_2_annual_energy_consumption_below_baseline_EEI')
