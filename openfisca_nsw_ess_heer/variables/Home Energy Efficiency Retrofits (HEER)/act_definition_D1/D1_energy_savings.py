...
class D1_residential_electricity_savings_factor(Variable):
    value_type = float
    entity = Building
    ...
    def formula(buildings, period, parameters):
        window_or_door_rating = buildings('D1_system_U_value', period)
        ...
        residential_electricity_savings_factor = parameters(period).table_D1_2.residential_electricity_savings_factor[U_value_rating][activity_climate_zone]
        return residential_electricity_savings_factor


class D1_residential_gas_savings_factor(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        ...
        activity_climate_zone = select([climate_zone == BCAClimateZone.BCA_Climate_Zones_2_and_3,
                                       ...
                                       ["climate_zones_2_and_3",
                                        ...
                                        "climate_zone_6",
                                        "climate_zones_7_and_8"])
        residential_gas_savings_factor = parameters(period).table_D1_3.residential_gas_savings_factor[U_value_rating][activity_climate_zone]
