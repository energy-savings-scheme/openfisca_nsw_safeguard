...
class D18_a_deemed_activity_electricity_savings(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        electricial_energy = electricial_energy / parameters(period).general_ESS.GJ_to_MWh
...
class D18_a_deemed_activity_gas_savings(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        supplementary_energy  = supplementary_energy / parameters(period).general_ESS.GJ_to_MWh
        ...
        gas_savings_factor = (baseline_B - coefficient_a * electricial_energy)
