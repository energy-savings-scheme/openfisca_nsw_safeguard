...
class D2_existing_window_is_single_glazed(Variable):
    value_type = bool
    entity = Building
...
class D2_existing_door_is_fully_single_glazed_framed_unit(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D2_existing_window_is_external(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D2_existing_door_is_external(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D2_is_residential_or_small_business_site(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D2_all_eligibility_requirements_are_true(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
