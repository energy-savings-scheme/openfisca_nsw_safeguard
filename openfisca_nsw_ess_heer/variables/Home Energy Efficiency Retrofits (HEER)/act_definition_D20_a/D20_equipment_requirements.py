...
class D20_a_is_listed_on_product_register(Variable):
    value_type = bool
    entity = Building
...
class D20_a_is_certified_to_AS_NZS_2712(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D20_a_meets_VEU_ESC_product_application_guide_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D20_a_meets_all_equipment_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        listed_on_product_register = buildings('D20_a_is_listed_on_product_register', period)
        product_is_certified_to_standard = buildings('D20_a_is_certified_to_AS_NZS_2712', period)
        meets_VEU_product_requirements = buildings('D20_a_meets_VEU_ESC_product_application_guide_requirements', period)
        return (listed_on_product_register * product_is_certified_to_standard * meets_VEU_product_requirements)
