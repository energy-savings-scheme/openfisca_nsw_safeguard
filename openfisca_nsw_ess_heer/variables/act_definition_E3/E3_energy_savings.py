...
class E3_residential_savings_factor(Variable):
    ...
    def formula(buildings, period, parameters):
        existing_lamp_LCP = buildings('existing_lamp_LCP')
        ...
        residential_building_savings_factor = (parameters(period).energy_savings_scheme.HEER.table_E3_1.residential_savings_factor
