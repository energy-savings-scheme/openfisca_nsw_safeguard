...
class E3_new_end_user_equipment_is_eligible(Variable):
    value_type = bool
    entity = Building
...
class E3_meets_A9_4_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class E3_new_lamp_life(Variable):
    value_type = int
    entity = Building
    definition_period = ETERNITY
...
class E3_minimum_lamp_life(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class E3_original_light_beam_angle(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class E3_new_light_beam_angle(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class E3_light_beam_angles_are_consistent(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        original_light_beam_angle = buildings('E3_original_light_beam_angle', period)
        new_light_beam_angle = buildings('E3_new_light_beam_angle', period)
