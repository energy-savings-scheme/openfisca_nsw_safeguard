...
class D19_a_is_listed_on_product_register(Variable):
    value_type = bool
    entity = Building
...
class D19_a_is_certified_to_AS_NZS_2712(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D19_a_certified_to_60_percent_savings_in_zone_HP5_AU(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    label = 'Is the End User Equipment certified to the standard of AS/NZS' \
...
class D19_a_meets_VEU_ESC_product_application_guide_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class D19_a_meets_all_equipment_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        listed_on_product_register = buildings('D19_a_is_listed_on_product_register', period)
        product_is_certified_to_standard = buildings('D19_a_is_certified_to_AS_NZS_2712', period)
        ...
        certified_to_60_percent_savings = buildings('D19_a_certified_to_60_percent_savings_in_zone_HP5_AU', period)
        meets_minimum_savings_if_required = ((in_climate_zone_7_and_8 * certified_to_60_percent_savings)
        + (not(in_climate_zone_7_and_8)))
        meets_VEU_product_requirements = buildings('D19_a_meets_VEU_ESC_product_application_guide_requirements', period)
