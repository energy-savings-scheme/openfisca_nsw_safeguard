...
class BESS1_PDRSAug24_demand_shifting_component(BaseVariable):
    value_type = float
    entity = Building
    ...
    def formula(buildings, period, parameters):
        usable_battery_capacity = buildings('BESS1_PDRSAug24_usable_battery_capacity', period)
...
class BESS1_PDRSAug24_peak_demand_shifting_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        demand_shifting_component = buildings('BESS1_PDRSAug24_demand_shifting_component', period)
...
class BESS1_PDRSAug24_peak_demand_annual_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS1_PDRSAug24_peak_demand_reduction_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
       peak_demand_shifting_capacity = buildings('BESS1_PDRSAug24_peak_demand_shifting_capacity', period)
...
class BESS1_PDRSAug24_PRC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        peak_demand_reduction_capacity = buildings('BESS1_PDRSAug24_peak_demand_reduction_capacity', period)
        network_loss_factor = buildings('BESS1_PDRSAug24_get_network_loss_factor_by_postcode', period)
        installation_eligibility = buildings('BESS1_PDRSAug24_installation_activity', period)
