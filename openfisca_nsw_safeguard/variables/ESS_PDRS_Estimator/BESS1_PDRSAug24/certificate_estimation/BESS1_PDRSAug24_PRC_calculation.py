...
class BESS1_PDRSAug24_demand_shifting_component(Variable):
    value_type = float
    entity = Building
...
class BESS1_PDRSAug24_peak_demand_shifting_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS1_PDRSAug24_peak_demand_annual_savings(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS1_PDRSAug24_peak_demand_reduction_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS1_PDRSAug24_PRC_calculation(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
