...
class BESS1_PDRSAug24_PDRS__postcode(BaseVariable):
    value_type = int
    entity = Building
...
class BESS1_PDRSAug24_installation_activity(BaseVariable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class BESS1_PDRSAug24_usable_battery_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class BESS1_PDRSAug24_get_network_loss_factor_by_postcode(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
