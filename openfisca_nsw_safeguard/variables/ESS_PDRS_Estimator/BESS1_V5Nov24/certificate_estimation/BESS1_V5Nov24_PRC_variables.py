...
class BESS1_V5Nov24_PDRS__postcode(Variable):
    value_type = int
    entity = Building
...
class BESS1_V5Nov24_installation_activity(Variable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class BESS1_V5Nov24_usable_battery_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class BESS1_V5Nov24_get_network_loss_factor_by_postcode(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
