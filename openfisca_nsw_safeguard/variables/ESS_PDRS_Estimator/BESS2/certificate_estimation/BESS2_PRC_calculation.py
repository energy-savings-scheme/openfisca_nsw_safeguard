...
class BESS2_demand_response_component(BaseVariable):
    value_type = float
    entity = Building
...
class BESS2_peak_demand_response_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        demand_response_component = buildings('BESS2_demand_response_component', period)
...
class BESS2_peak_demand_annual_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS2_peak_demand_reduction_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS2_PRC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
