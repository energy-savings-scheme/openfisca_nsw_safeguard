...
class BESS2_PDRS__postcode(BaseVariable):
    value_type = int
    entity = Building
...
class BESS2_installation_activity(BaseVariable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class BESS2_usable_battery_capacity(BaseVariable):
    value_type = float
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class BESS2_get_network_loss_factor_by_postcode(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
    ...
    def formula(building, period, parameters):
        postcode = building('BESS2_PDRS__postcode', period)
