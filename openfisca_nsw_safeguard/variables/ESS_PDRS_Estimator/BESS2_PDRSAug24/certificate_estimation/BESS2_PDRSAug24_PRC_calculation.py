...
class BESS2_PDRSAug24_demand_response_component(BaseVariable):
    value_type = float
    entity = Building
...
class BESS2_PDRSAug24_peak_demand_response_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS2_PDRSAug24_peak_demand_annual_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS2_PDRSAug24_peak_demand_reduction_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class BESS2_PDRSAug24_PRC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
