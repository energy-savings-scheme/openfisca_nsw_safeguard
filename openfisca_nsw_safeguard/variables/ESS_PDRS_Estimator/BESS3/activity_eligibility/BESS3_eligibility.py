...
class BESS3_installation_final_activity_eligibility(BaseVariable):
    ...
    def formula(buildings, period, parameter):
        ...
        retainable_battery_capacity_warranty = buildings(
            "BESS3_retainable_battery_capacity_warranty", period
        )
        ...
        end_formula = (
            ...
            * minimum_payment
            * battery_capacity
            * length_battery_warranty
            * retainable_battery_capacity_warranty
            * approved_batteries_list
            * battery_inverter_output
            * installation_location
            * behind_meter
            * approved_installer_list
            * licensed_person
            * internet_connectable
            * controlled_aggregator
        )
