...
class D17_equipment_replaced(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
...
class D17_equipment_replaces_electric(BaseVariable):
...
class D17_engaged_ACP(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D17_equipment_removed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D17_equipment_installed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D17_installed_by_qualified_person(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D17_equipment_registered_IPART(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
