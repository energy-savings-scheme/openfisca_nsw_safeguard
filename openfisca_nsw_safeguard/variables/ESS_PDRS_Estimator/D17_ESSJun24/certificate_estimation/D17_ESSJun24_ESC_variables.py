...
class D17_ESSJun24_PDRS__postcode(BaseVariable):
    value_type = int
    entity = Building
...
class D17_ESSJun24_BCA_climate_zone_by_postcode(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D17_ESSJun24_BCA_climate_zone_by_postcode_int(BaseVariable):
    value_type = int
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D17_ESSJun24_get_HP_zone_by_BCA_climate_zone(BaseVariable): 
    value_type = int
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_regional_network_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_replacement_activity(BaseVariable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_system_size(BaseVariable):
    value_type = Enum
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_system_size_int(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_Baseline_A(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_adjustment_coefficient(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D17_ESSJun24_Bs(BaseVariable):
...
class D17_ESSJun24_Be(BaseVariable):
    reference = 'Gj per year'
    value_type = float
    entity = Building
    definition_period = ETERNITY
