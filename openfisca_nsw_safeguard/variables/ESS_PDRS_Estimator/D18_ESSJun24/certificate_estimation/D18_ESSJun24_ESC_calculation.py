...
class D18_ESSJun24_deemed_activity_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
...
class D18_ESSJun24_annual_energy_savings(BaseVariable):
    value_type = float  
    entity = Building
    definition_period = ETERNITY
    label = 'Deemed activity electricity savings'
...
class D18_ESSJun24_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D18_ESSJun24_ESC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
