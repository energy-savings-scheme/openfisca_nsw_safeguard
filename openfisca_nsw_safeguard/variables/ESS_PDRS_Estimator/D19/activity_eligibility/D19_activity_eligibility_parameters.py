...
class D19_equipment_replaced(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    ...
    metadata = {
      ...
      'sorting' : 1,
      'eligibility_clause' : """A new installation is not eligible under ESS Activity D19. In ESS D19 the activity definition states that the activity must be the replacement of an existing gas water heater with an (air source) heat pump water heater."""
    }


class D19_equipment_replaces_gas(BaseVariable):
    ...
    definition_period = ETERNITY
    metadata = {
      'display_question' : 'Is the equipment that is being replaced a gas storage or instantaneous water heater?',
      'sorting' : 2,
      'eligibility_clause' : """In ESS D19 Eligibility Requirements Clause 1 it states that the existing gas water heater must be a gas storage or instantaneous water heater."""
    }


class D19_engaged_ACP(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D19_equipment_removed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D19_equipment_installed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D19_installed_by_qualified_person(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D19_equipment_registered_IPART(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
