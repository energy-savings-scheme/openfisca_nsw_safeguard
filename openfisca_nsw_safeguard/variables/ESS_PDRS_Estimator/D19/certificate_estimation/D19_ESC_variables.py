...
class D19_PDRS__postcode(BaseVariable):
    value_type = int
    entity = Building
...
class D19_BCA_climate_zone_by_postcode(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D19_BCA_climate_zone_by_postcode_int(BaseVariable):
    value_type = int
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D19_get_HP_zone_by_BCA_climate_zone(BaseVariable): 
    value_type = int
    entity = Building
    definition_period = ETERNITY
...
class D19_regional_network_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D19_replacement_activity(BaseVariable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class D19_system_size(BaseVariable):
    value_type = Enum
    entity = Building
    definition_period = ETERNITY
...
class D19_system_size_int(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
...
class D19_Baseline_A(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D19_Baseline_B(BaseVariable):
