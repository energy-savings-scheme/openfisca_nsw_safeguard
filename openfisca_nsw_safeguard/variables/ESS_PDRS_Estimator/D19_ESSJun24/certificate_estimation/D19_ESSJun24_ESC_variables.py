...
class D19_ESSJun24_PDRS__postcode(Variable):
 ...
 class D19_ESSJun24_get_HP_zone_by_postcode(Variable): 
    value_type = int
    entity = Building
    definition_period = ETERNITY
    
    def formula(building, period, parameters):
        BCA_climate_zone = building('D19_ESSJun24_PDRS__postcode', period)
...
class D19_ESSJun24_Baseline_A(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        heat_pump_zone = buildings('D19_ESSJun24_get_HP_zone_by_postcode', period)
