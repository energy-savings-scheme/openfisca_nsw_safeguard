...
class D20_PDRS__postcode(BaseVariable):
    value_type = int
    entity = Building
...
class D20_BCA_climate_zone_by_postcode(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D20_BCA_climate_zone_by_postcode_int(BaseVariable):
    value_type = int
    entity = Building
    definition_period = ETERNITY
    metadata={
...
class D20_get_HP_zone_by_BCA_climate_zone(BaseVariable): 
    value_type = int
    entity = Building
    definition_period = ETERNITY
    
    def formula(building, period, parameters):
        BCA_climate_zone = building('D20_BCA_climate_zone_by_postcode_int', period)
...
class D20_regional_network_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class D20_replacement_activity(BaseVariable):
    value_type = bool
    default_value = True
    entity = Building
    definition_period = ETERNITY
...
class D20_system_size(BaseVariable):
    value_type = Enum
    entity = Building
    definition_period = ETERNITY
...
class D20_system_size_int(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY

    def formula(buildings, period, parameters):
        system_size = buildings('D20_system_size', period)
...
class D20_Baseline_A(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY

    def formula(buildings, period, parameters):
        system_size = buildings('D20_system_size_int', period)

        baseline_A = parameters(period).ESS.HEER.table_D20_1['baseline_energy_consumption'][system_size]['baseline_A']
        return baseline_A


class D20_Bs(BaseVariable):
...
class D20_Baseline_B(BaseVariable):
    ...
    def formula(buildings, period, parameters):
        ...
        baseline_B = parameters(period).ESS.HEER.table_D20_1['baseline_energy_consumption'][system_size]['baseline_B']
        return baseline_B