...
class D20_ESSJun24_equipment_replaced(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    ...
    metadata = {
      ...
      'sorting' : 1,
      'eligibility_clause' : """A new installation is not eligible under ESS Activity D20. In ESS D20 the activity definition states that the activity must be the replacement of an existing gas water heater with a solar (electric boosted) water heater.<br />
                                ESS D20 Eligibility Requirements Clause 1 also states that the existing existing gas water heater must be a gas storage or instantaneous water heater."""
    }


class D20_ESSJun24_engaged_ACP(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D20_ESSJun24_minimum_payment(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D20_ESSJun24_equipment_removed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D20_ESSJun24_equipment_installed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D20_ESSJun24_installed_by_qualified_person(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class D20_ESSJun24_equipment_registered_IPART(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
