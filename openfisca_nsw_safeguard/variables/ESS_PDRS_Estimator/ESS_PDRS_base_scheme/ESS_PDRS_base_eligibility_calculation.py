...
class ESS__PDRS__ACP_base_scheme_eligibility(BaseVariable):
    """
    ...
    def formula(buildings, period, parameter):
        ...
        implementation_date_eligibility = buildings('Implementation_date_eligibility', period)
        ...
        end_formula =  ( energy_consumption * implementation_date_eligibility * reduce_demand * lawful * engaged_an_ACP *
