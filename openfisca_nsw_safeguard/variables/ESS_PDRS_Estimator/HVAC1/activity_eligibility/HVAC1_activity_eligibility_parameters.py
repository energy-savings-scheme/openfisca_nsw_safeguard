...
class HVAC1_installation(Variable):
    ...
    metadata = {
        ...
        'sorting' : 1,
        'eligibility_clause' : """In PDRS HVAC1 Eligibility Requirements Clause 1, it states that this activity must be an installation of a new high efficiency air conditioner or a replacement of an existing air conditioner (whether operational or not) 
...
class HVAC1_equipment_removed(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
    metadata = {
        ...
        'sorting' : 3,
        'conditional' : 'True',
        'eligibility_clause' : """In PDRS HVAC1 Implementation Requirements Clause 3, it states that the activity, including the removal of any existing End-User Equipment, must be 
...
class HVAC1_installed_by_qualified_person(Variable):
    ...
    metadata = {
        ...
        'sorting' : 4,
        'conditional': 'True',
        'eligibility_clause' : """In PDRS HVAC1 Implementation Requirements Clause 3, it states that the activity, including the removal
...
class HVAC1_AEER_greater_than_minimum(Variable):
    ...
    definition_period = ETERNITY
    metadata = {
        'display_question' : 'Is your AEER equal to or greater than the Minimum AEER for the Product Type and Cooling Capacity in Table HVAC1.4?',
        'sorting' : 8,
        'conditional' : 'True',
        'eligibility_clause' : """In PDRS HVAC1 Equipment Requirements Clause 2 it states that if the New End-User Equipment or replacement End-User Equipment has a Cooling Capacity recorded in the GEMS Registry: \n
        a. The New End-User Equipment or replacement End-User Equipment must have a Residential TCSPF_mixed value, as recorded in the GEMS Registry, equal to or greater than the Minimum Residential TCSPF_mixed value for the corresponding Product Type and Cooling Capacity in Table HVAC1.3; or /n
...
class HVAC1_TCPSF_greater_than_minimum(Variable):
    ...
    definition_period = ETERNITY
    metadata = {
        'display_question' : 'Is your Residential TCSPF_mixed value equal to or greater than the Minimum Residential TCPSF_mixed value for the same Product Type and Cooling Capacity in Table HVAC1.3?',
        'sorting' : 9,
        'conditional' : 'True',
        'eligibility_clause' : """In PDRS HVAC1 Equipment Requirements Clause 2 it states that if the New End-User Equipment or replacement End-User Equipment has a Cooling Capacity recorded in the GEMS Registry: \n
        a. The New End-User Equipment or replacement End-User Equipment must have a Residential TCSPF_mixed value, as recorded in the GEMS Registry, equal to or greater than the Minimum Residential TCSPF_mixed value for the corresponding Product Type and Cooling Capacity in Table HVAC1.3; or /n
...
class HVAC1_new_equipment_heating_capacity(Variable):
    ...
    metadata = {
        ...
        Minimum Residential HSPF_cold value for the same Product Type and Cooling Capacity in Table D16.4; or\n
