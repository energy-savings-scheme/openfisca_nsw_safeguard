...
class HVAC1_rated_ACOP_input(Variable):
    ...
    metadata = {
        "alias": "Rated ACOP",
        'display_question': 'Annual Coefficient of Performance (ACOP) as defined in GEMS (air conditioners up to 65kW) Determination 2019',
        'sorting' : 11,
        'label': 'Rated ACOP'
    }
...
class HVAC1_rated_AEER_input(Variable):
    ...
    metadata = {
        "alias": "Rated AEER",
        "display_question": 'Annual Energy Efficiency Ratio as defined in GEMS (Air Conditioners up to 65kW) Determination 2019',
        'sorting': 7,
        'label': 'Rated AEER'
    }
