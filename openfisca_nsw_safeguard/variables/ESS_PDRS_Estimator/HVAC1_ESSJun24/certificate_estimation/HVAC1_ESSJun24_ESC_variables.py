...
"""
class HVAC1_ESSJun24_heating_capacity_input(BaseVariable):
...
class HVAC1_ESSJun24_cooling_capacity_input(BaseVariable):
    reference = 'unit in kw'
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_rated_ACOP_input(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_baseline_AEER_input(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
    ...
    def formula(building, period, parameters):
        cooling_capacity = building('HVAC1_ESSJun24_cooling_capacity_input', period)
        ...
        air_conditioner_type = building('HVAC1_ESSJun24_Air_Conditioner_type', period)
        aircon = np.select(
        ...
        new_or_replacement_activity = building('HVAC1_ESSJun24_Activity', period)
...
class HVAC1_ESSJun24_rated_AEER_input(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_certificate_climate_zone(BaseVariable):
    value_type = int
    entity = Building
    ...
    def formula(building, period, parameters):
        postcode = building('HVAC1_ESSJun24_PDRS__postcode', period)
        rnf = parameters(period).ESS.ESS_general.table_A27_4_climate_zone_by_postcode
        zone_int = rnf.calc(postcode)
        return zone_int


class HVAC1_ESSJun24_get_climate_zone_by_postcode(BaseVariable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_PDRS__postcode(BaseVariable):
...
class HVAC1_ESSJun24_residential_THEC(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY 
    metadata = {
...
class HVAC1_ESSJun24_equivalent_heating_hours_input(BaseVariable):
    ...
    def formula(building, period, parameters):
        climate_zone = building('HVAC1_ESSJun24_certificate_climate_zone', period)
...
class HVAC1_ESSJun24_residential_TCEC(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY 
    metadata = {
...
class HVAC1_ESSJun24_equivalent_cooling_hours_input(BaseVariable):
    reference = 'unit in hours per year'
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_baseline_ACOP_input(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(building, period, parameters):
        cooling_capacity = building(
            'HVAC1_ESSJun24_cooling_capacity_input', period)
...
class HVAC1_ESSJun24_Air_Conditioner_type(BaseVariable):
    value_type = Enum
    entity = Building
...
class HVAC1_ESSJun24_Activity(BaseVariable):
    value_type = Enum
    entity = Building
...
class HVAC1_ESSJun24_TCSPF_mixed(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_TCSPF_or_AEER_exceeds_ESS_benchmark(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_HSPF_mixed(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_HSPF_cold(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_HSPF_or_ACOP_exceeds_ESS_benchmark(BaseVariable):
    ...
    def formula(buildings, period, parameters):
        AC_HSPF_mixed = buildings('HVAC1_ESSJun24_HSPF_mixed', period)
        AC_HSPF_cold = buildings('HVAC1_ESSJun24_HSPF_cold', period)
        AC_ACOP = buildings('HVAC1_ESSJun24_rated_ACOP_input', period)
        product_class = buildings('HVAC1_ESSJun24_Air_Conditioner_type', period)
        new_AC_cooling_capacity = buildings('HVAC1_ESSJun24_cooling_capacity_input', period)
        cooling_capacity = np.select(
                                    [
