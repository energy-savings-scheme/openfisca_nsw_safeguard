...
"""
class HVAC1_ESSJun24_heating_capacity_input(Variable):
...
class HVAC1_ESSJun24_cooling_capacity_input(Variable):
    reference = 'unit in kw'
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_rated_ACOP_input(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_baseline_AEER_input(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_rated_AEER_input(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_certificate_climate_zone(Variable):
    value_type = int
    entity = Building
...
class HVAC1_ESSJun24_get_climate_zone_by_postcode(Variable):
    value_type = str
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_PDRS__postcode(Variable):
...
class HVAC1_ESSJun24_residential_THEC(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY 
    metadata = {
...
class HVAC1_ESSJun24_equivalent_heating_hours_input(Variable):
...
class HVAC1_ESSJun24_residential_TCEC(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY 
    metadata = {
...
class HVAC1_ESSJun24_equivalent_cooling_hours_input(Variable):
    reference = 'unit in hours per year'
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_baseline_ACOP_input(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_Air_Conditioner_type(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_ESSJun24_Activity(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_ESSJun24_TCSPF_mixed(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_TCSPF_or_AEER_exceeds_ESS_benchmark(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_ESSJun24_HSPF_mixed(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_HSPF_cold(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_ESSJun24_HSPF_or_ACOP_exceeds_ESS_benchmark(Variable):
