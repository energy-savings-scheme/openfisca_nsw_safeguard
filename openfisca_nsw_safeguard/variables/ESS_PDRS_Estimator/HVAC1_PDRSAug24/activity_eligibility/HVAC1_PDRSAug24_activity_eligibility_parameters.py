...
class HVAC1_PDRSAug24_new_installation_or_replacement(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_PDRSAug24_new_installation_or_replacement_eligible(Variable):
...
class HVAC1_PDRSAug24_installed_by_qualified_person(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_equipment_installed(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_engaged_ACP(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_minimum_payment(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_equipment_registered_in_GEMS(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_new_equipment_cooling_capacity(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_AEER_greater_than_minimum(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_TCPSF_greater_than_minimum(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_climate_zone(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_PDRSAug24_new_equipment_heating_capacity(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_HSPF_mixed_eligible(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_ACOP_eligible(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    default_value = True
...
class HVAC1_PDRSAug24_HSPF_cold_eligible(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
