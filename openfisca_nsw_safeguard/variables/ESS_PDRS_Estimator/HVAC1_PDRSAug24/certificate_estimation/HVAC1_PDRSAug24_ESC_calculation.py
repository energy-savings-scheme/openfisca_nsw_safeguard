...
class HVAC1_PDRSAug24_heating_annual_energy_use(Variable):
    value_type = float
    entity = Building
...
class HVAC1_PDRSAug24_cooling_annual_energy_use(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_reference_heating_annual_energy_use(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_PDRSAug24_THEC_or_annual_heating(Variable):
...
class HVAC1_PDRSAug24_reference_cooling_annual_energy_use(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class HVAC1_PDRSAug24_TCEC_or_annual_cooling(Variable):
...
class HVAC1_PDRSAug24_deemed_activity_electricity_savings(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_Air_Conditioner_type_savings(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_PDRSAug24_Activity_savings(Variable):
    value_type = Enum
    entity = Building
...
class HVAC1_PDRSAug24_annual_energy_savings(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_PDRS__regional_network_factor(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_electricity_savings(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class HVAC1_PDRSAug24_ESC_calculation(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
