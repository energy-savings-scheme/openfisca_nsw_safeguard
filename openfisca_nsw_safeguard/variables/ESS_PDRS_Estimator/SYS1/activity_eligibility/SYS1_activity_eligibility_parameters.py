...
class SYS1_new_motor_for_ventilation_refrigeration(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
...
class SYS1_equipment_registered_in_GEMS(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS1_engaged_ACP(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS1_high_efficiency(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS1_equipment_installed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS1_rated_output_eligible(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
