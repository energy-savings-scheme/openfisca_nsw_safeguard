...
class SYS2_qualified_install_removal(Variable):
    ...
    metadata = {
      ...
      'sorting' : 3,
      'eligibility_clause' : """In PDRS SYS2 Implementation Requirements Clause 1 it states that the activity, including the removal of the existing End-User Equipment, must be 
...
class SYS2_equipment_registered_in_GEMS(Variable):
    ...
    metadata = {
        ...
        'sorting' : 5,
        'eligibility_clause' : """In PDRS SYS2 Equipment Requirements Clause 2 it states that the new End-User Equipment must be listed as part of a labelling scheme 
                                  determined in accordance with the Equipment Energy Efficiency (E3) Committee's Voluntary Energy Rating Labelling Program for Swimming 
                                  Pool Pump-units: Rules for Participation, April 2010, or be a registered product in the GEMS Registry as complying with the Greenhouse 
                                  and Energy Minimum Standards (Swimming Pool Pump-units) Determination 2021."""
    }
...
class SYS2_voluntary_labelling_scheme(Variable):
    ...
    metadata = {
      ...
      'sorting' : 6,
      'conditional': 'True',
      'eligibility_clause' : """In PDRS SYS2 Equipment Requirements Clause 2 it states that the new End-User Equipment must be listed as part of a labelling scheme determined in accordance with the Equipment Energy Efficiency (E3) Committee's 
                                Voluntary Energy Rating Labelling Program for Swimming Pool Pump-units: Rules for Participation, April 2010, or be a registered product in the GEMS Registry as complying with the Greenhouse and Energy Minimum 
                                Standards (Swimming Pool Pump-units) Determination 2021."""
    }
...
class SYS2_single_speed_input_power(Variable):
    ...
    definition_period = ETERNITY
    metadata = {
      'display_question' : 'Is the input power of the single-speed pump unit between 600w and 1700w?',
      'sorting' : 12,
      'conditional': 'True',
      'eligibility_clause' : """In PDRS SYS2 Equipment Requirements Clause 1 it states that the New End-User Equipment must be a product for use with a domestic 
                                pool or spa that is a single phase motor and any of the following types: single speed, two speed, multi speed or variable speed 
