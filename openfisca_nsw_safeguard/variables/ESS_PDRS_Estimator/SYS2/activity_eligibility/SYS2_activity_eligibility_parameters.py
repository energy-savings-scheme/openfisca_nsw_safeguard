...
class SYS2_equipment_registered_in_GEMS(Variable):
    ...
    metadata = {
        ...
        'sorting' : 6,
        'eligibility_clause' : """In PDRS SYS2 Equipment Requirements Clause 1 it states that the new or replacement End-User Equipment must be registered in the GEMS Registry as complying with the Greenhouse and Energy Minimum Standards (Swimming Pool Pump-units) Determination 2021."""
    }
