...
class SYS2_PDRSAug24_equipment_replaced(Variable):
    value_type = bool
    entity = Building
    default_value = True
...
class SYS2_PDRSAug24_old_equipment_installed_on_site(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_legal_disposal(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_voluntary_labelling_scheme(Variable):
    #only show this question if SYS2_PDRSAug24_equipment_registered_in_GEMS is false
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_star_rating_minimum_four_and_a_half(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_single_phase(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_multiple_speed(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_multiple_speeds_input_power(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class SYS2_PDRSAug24_single_speed_input_power(Variable):
    #only display this question if SYS2_PDRSAug24_multiple_speed is false
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
