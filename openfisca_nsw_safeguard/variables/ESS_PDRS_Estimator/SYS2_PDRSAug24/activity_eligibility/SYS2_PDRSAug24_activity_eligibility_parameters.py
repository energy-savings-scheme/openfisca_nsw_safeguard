...
class SYS2_PDRSAug24_minimum_payment(Variable):
    ...
    metadata = {
      ...
      'sorting' : 6,
      'eligibility_clause' : """In ESS Clause 9.8.1F it states that the Accredited Certificate Provider must have evidence satisfactory to the Scheme Administrator that the Purchaser has paid for the Implementation, assessment and other associated works carried out at the Site a Net Amount of at least $200 (excluding GST) for each item of End-User Equipment installed as part of an Implementation using any of Activity Definitions D5, D16, D17, D18, D19, D20 and D21."""
    }
