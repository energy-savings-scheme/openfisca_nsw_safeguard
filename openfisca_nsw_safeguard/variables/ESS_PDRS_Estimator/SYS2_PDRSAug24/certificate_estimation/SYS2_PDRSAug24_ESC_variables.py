...
"""
class SYS2_PDRSAug24_PDRS__postcode(BaseVariable):
...
class SYS2_PDRSAug24_maximum_tested_input_power(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class SYS2_PDRSAug24_projected_annual_energy_consumption(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class SYS2_PDRSAug24_daily_run_time(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class SYS2_PDRSAug24_PAEC_baseline(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
