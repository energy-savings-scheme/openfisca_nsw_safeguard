...
class WH1_F16_electric_equipment_replaced(Variable):
    value_type = bool
    entity = Building
    default_value = True
...
class WH1_F16_electric_equipment_removed(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_F16_electric_engaged_ACP(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_F16_electric_minimum_payment(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_F16_electric_building_BCA_not_class_1_or_4(Variable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class WH1_F16_electric_scheme_admin_approved(Variable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_F16_electric_StorageVolume(Enum):
    less_than_or_equal_to_700_L = 'Less than or equal to 700 litres'
    more_than_700_L = 'More than 700 litres'

    
class WH1_F16_electric_storage_volume(Variable):
    value_type = Enum
    entity = Building
    default_value = WH1_F16_electric_StorageVolume.more_than_700_L
    possible_values = WH1_F16_electric_StorageVolume
    definition_period = ETERNITY
    metadata = {
...
class WH1_F16_electric_storage_volume_int(Variable):
    value_type = int
    entity = Building 
    definition_period = ETERNITY

    def formula(buildings, period, parameters):
      storage_volume = buildings('WH1_F16_electric_storage_volume', period)
      ...
      [
        WH1_F16_electric_StorageVolume.less_than_or_equal_to_700_L,
        WH1_F16_electric_StorageVolume.more_than_700_L
      ])

      return storage_volume_int


class WH1_F16_electric_certified(Variable):
...
class WH1_F16_electric_equipment_certified_by_storage_volume(Variable):
    ...
    def formula(buildings, period, parameters):
      storage_volume = buildings('WH1_F16_electric_storage_volume', period)
      certified_AS_NZ_2712 = buildings('WH1_F16_electric_certified', period)

      eligible_by_storage = np.select(
        [
          (storage_volume == WH1_F16_electric_StorageVolume.less_than_or_equal_to_700_L) * certified_AS_NZ_2712,
          (storage_volume == WH1_F16_electric_StorageVolume.less_than_or_equal_to_700_L) * np.logical_not(certified_AS_NZ_2712),
          (storage_volume == WH1_F16_electric_StorageVolume.more_than_700_L)
        ],
        [
          True,
          False,
