...
class WH1_ESSJun24_equipment_replaced(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
...
class WH1_ESSJun24_equipment_removed(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_ESSJun24_engaged_ACP(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_ESSJun24_minimum_payment(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_ESSJun24_building_BCA_not_class_1_or_4(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class WH1_ESSJun24_scheme_admin_approved(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
    definition_period = ETERNITY
...
class WH1_ESSJun24_storage_volume(BaseVariable):
    value_type = Enum
    entity = Building
...
class WH1_ESSJun24_storage_volume_int(BaseVariable):
    value_type = int
    entity = Building 
    definition_period = ETERNITY
...
class WH1_ESSJun24_certified(BaseVariable):
...
class WH1_ESSJun24_equipment_certified_by_storage_volume(BaseVariable):
