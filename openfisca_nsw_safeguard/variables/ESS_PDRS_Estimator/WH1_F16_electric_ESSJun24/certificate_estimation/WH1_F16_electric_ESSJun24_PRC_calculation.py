...
class WH1_F16_electric_ESSJun24_baseline_input_power(Variable):
    value_type = float
    entity = Building
...
class WH1_F16_electric_ESSJun24_input_power(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_ESSJun24_peak_demand_savings_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_ESSJun24_peak_demand_annual_savings(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_ESSJun24_peak_demand_reduction_capacity(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_ESSJun24_PRC_calculation(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
