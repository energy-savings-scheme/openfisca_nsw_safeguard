...
class WH1_F16_electric_ESSJun24_baseline_input_power(BaseVariable):
    value_type = float
    entity = Building
...
class WH1_F16_electric_ESSJun24_input_power(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        annual_energy_savings = buildings('WH1_F16_electric_ESSJun24_annual_energy_savings', period)
        baseline_input_power = buildings('WH1_F16_electric_ESSJun24_baseline_input_power', period)

        input_power = (100 - annual_energy_savings) * (baseline_input_power / 100)
        return input_power


class WH1_F16_electric_ESSJun24_peak_demand_savings_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        ...
        input_power = buildings('WH1_F16_electric_ESSJun24_input_power', period)
...
class WH1_F16_electric_ESSJun24_peak_demand_annual_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_ESSJun24_peak_demand_reduction_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        peak_demand_savings_capacity = buildings('WH1_F16_electric_ESSJun24_peak_demand_savings_capacity', period)
...
class WH1_F16_electric_ESSJun24_PRC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
    ...
    def formula(buildings, period, parameters):
        peak_demand_capacity = buildings('WH1_F16_electric_ESSJun24_peak_demand_reduction_capacity', period)
        network_loss_factor = buildings('WH1_F16_electric_ESSJun24_get_network_loss_factor_by_postcode', period)
        kw_to_0_1kw = 10
