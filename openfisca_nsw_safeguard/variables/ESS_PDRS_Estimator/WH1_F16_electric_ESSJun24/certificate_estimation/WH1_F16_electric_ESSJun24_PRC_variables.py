...
class WH1_F16_electric_ESSJun24_BCA_climate_zone_by_postcode(Variable):
    ...
    def formula(buildings, period, parameters):
        postcode = buildings('WH1_F16_electric_ESSJun24_PDRS__postcode', period)
        # Returns an integer
...
class WH1_F16_electric_ESSJun24_get_HP_zone_by_BCA_climate_zone(Variable): 
    ...
    def formula(building, period, parameters):
        BCA_climate_zone = building('WH1_F16_electric_ESSJun24_BCA_climate_zone_by_postcode_int', period)
...
class WH1_F16_electric_ESSJun24_get_network_loss_factor_by_postcode(Variable):
    ...
    def formula(building, period, parameters):
        postcode = building('WH1_F16_electric_ESSJun24_PDRS__postcode', period)
...
class WH1_F16_electric_ESSJun24_annual_energy_savings_eligible(Variable):
    ...
    def formula(buildings, period, parameters):
        minimum_savings = buildings('WH1_F16_electric_ESSJun24_annual_energy_savings', period)
        heat_pump_zone = buildings('WH1_F16_electric_ESSJun24_get_HP_zone_by_BCA_climate_zone', period)
