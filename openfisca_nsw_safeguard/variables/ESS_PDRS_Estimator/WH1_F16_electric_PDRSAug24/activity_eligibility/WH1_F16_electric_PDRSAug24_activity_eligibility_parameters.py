...
class WH1_F16_electric_PDRSAug24__storage_volume(Variable):
    ...
    metadata = {
      ...
      'sorting' : 11,
      'eligibility_clause' : """In PDRS WH1 Equipment Requirements Clause 3 it states that the installed End-User Equipment must be certified to comply with AS/NZS 2712 if it has a storage volume less than or equal to 700L.
