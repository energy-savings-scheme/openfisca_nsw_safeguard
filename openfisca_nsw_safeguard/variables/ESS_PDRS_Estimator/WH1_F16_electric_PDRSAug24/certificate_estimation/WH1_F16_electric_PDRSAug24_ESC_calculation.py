...
class WH1_F16_electric_PDRSAug24_capacity_factor(BaseVariable):
    value_type = float
    entity = Building
...
class WH1_F16_electric_PDRSAug24_Ref_Elec(BaseVariable):
...
class WH1_F16_electric_PDRSAug24_deemed_activity_gas_savings(BaseVariable):
...
class WH1_F16_electric_PDRSAug24_deemed_activity_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_energy_savings(BaseVariable):
    value_type = float  
    entity = Building
    definition_period = ETERNITY
    metadata = {
...
class WH1_F16_electric_PDRSAug24_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_ESC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
