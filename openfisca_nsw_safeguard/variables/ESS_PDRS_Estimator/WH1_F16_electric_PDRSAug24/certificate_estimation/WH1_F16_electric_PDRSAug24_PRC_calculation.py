...
class WH1_F16_electric_PDRSAug24_baseline_input_power(BaseVariable):
    value_type = float
    entity = Building
...
class WH1_F16_electric_PDRSAug24_input_power(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_peak_demand_savings_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_peak_demand_annual_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_peak_demand_reduction_capacity(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class WH1_F16_electric_PDRSAug24_PRC_calculation(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    metadata = {
