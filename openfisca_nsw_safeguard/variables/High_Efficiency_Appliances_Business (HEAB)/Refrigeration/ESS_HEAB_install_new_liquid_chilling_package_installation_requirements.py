...
class ESS_HEAB_install_new_liquid_chilling_package_LCP_is_installed(BaseVariable):
    value_type = bool
    entity = Building
...
class ESS_HEAB_install_new_liquid_chilling_package_installation_requirements_are_met(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
