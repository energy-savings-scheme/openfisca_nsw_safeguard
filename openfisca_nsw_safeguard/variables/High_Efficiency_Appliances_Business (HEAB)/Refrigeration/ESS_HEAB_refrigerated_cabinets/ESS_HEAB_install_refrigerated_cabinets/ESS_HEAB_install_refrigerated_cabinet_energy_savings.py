...
class ESS_HEAB_install_refrigerated_cabinet_electricity_savings(Variable):
    value_type = float
    entity = Building
...
class ESS_HEAB_install_refrigerated_cabinet_meets_all_eligibility_criteria(Variable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
