...
class ESS_HEAB_install_refrigerated_cabinet_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
...
class ESS_HEAB_install_refrigerated_cabinet_meets_all_eligibility_criteria(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        meets_eligibility_requirements = buildings(
            'ESS_HEAB_install_refrigerated_cabinet_meets_eligibility_requirements', period)
