...
class ESS_HEAB_install_refrigerated_cabinet_is_under_baseline_EEI(BaseVariable):
    value_type = bool
    entity = Building
...
class ESS_HEAB_install_refrigerated_cabinet_meets_equipment_requirements(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
