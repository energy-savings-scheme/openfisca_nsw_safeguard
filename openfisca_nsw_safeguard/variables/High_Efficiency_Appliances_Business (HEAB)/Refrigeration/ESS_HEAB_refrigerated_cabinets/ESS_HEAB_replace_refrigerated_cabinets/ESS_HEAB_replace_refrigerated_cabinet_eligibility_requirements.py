...
class ESS_HEAB_replace_refrigerated_cabinet_activity_is_installation_of_RC(BaseVariable):
    value_type = bool
    entity = Building
...
class ESS_HEAB_replace_refrigerated_cabinet_meets_eligibility_requirements(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
