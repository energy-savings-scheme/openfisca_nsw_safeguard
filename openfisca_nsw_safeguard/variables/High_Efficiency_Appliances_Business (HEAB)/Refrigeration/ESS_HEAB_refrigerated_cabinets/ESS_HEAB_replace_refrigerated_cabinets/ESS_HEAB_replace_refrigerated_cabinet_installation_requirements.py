...
class ESS_HEAB_replace_refrigerated_cabinet_existing_equipment_is_removed(BaseVariable):
    value_type = bool
    entity = Building
...
class ESS_HEAB_replace_refrigerated_cabinet_new_equipment_is_installed_and_operating(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class ESS_HEAB_replace_refrigerated_cabinet_meets_installation_requirements(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
