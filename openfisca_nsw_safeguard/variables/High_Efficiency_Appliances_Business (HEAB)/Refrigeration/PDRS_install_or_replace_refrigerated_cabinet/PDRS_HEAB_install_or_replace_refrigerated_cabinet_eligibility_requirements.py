...
class PDRS_HEAB_install_or_replace_refrigerated_cabinet_activity_is_installation_or_removal_of_RC(Variable):
    value_type = bool
    entity = Building
...
class PDRS_HEAB_install_or_replace_refrigerated_cabinet_meets_eligibility_requirements(Variable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        activity_is_installing_RC = buildings(
            'PDRS_HEAB_install_or_replace_refrigerated_cabinet_activity_is_installation_or_removal_of_RC', period)
