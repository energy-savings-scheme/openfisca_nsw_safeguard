...
class ESS_HEAB_install_oxygen_trim_system_on_boiler_or_heater_meets_implementation_requirements(Variable):
    ...
    def formula(buildings, period, parameters):
        adheres_to_manufacturers_guidelines = buildings('ESS_HEAB_install_oxygen_trim_system_on_boiler_or_heater_installed_in_accordance_with_manufacturer_guidelines', period)
        adheres_to_relevants_standards_and_legislation = buildings('ESS_HEAB_install_oxygen_trim_system_on_boiler_or_heater_installed_in_accordance_with_relevant_standards_and_legislation', period)
        adheres_to_scheme_administrator_requirements = buildings('ESS_HEAB_install_oxygen_trim_system_on_boiler_or_heater_installed_in_accordance_with_scheme_administrator_requirements', period)
