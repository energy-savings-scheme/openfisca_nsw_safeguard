...
class ESS_HEER_AC_install_electricity_savings(Variable):
    ...
    label = 'What are the electricity savings created by installing a new AC?'
    metadata = {
        'alias': "HEER AC Install Electricity Savings",
    }

    def formula(buildings, period, parameters):
        reference_cooling_annual_energy_use = buildings(
            'ESS_HEER_AC_install_reference_cooling_annual_energy_use', period)
        cooling_annual_energy_use = buildings(
            'ESS_HEER_AC_install_cooling_annual_energy_use', period)
        reference_heating_annual_energy_use = buildings(
            'ESS_HEER_AC_install_reference_heating_annual_energy_use', period)
        heating_annual_energy_use = buildings(
            'ESS_HEER_AC_install_heating_annual_energy_use', period)
