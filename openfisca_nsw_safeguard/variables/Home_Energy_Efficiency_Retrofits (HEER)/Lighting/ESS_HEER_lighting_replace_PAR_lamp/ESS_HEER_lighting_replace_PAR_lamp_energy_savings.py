...
class ESS_HEER_lighting_replace_PAR_lamp_electricity_savings(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    label = 'Returns the electricity savings for activity definition E3.'
    ...
    def formula(buildings, period, parameters):
        ...
        electricity_savings = np.select(
                ...
                [
                        buildings('ESS_HEER_lighting_replace_PAR_lamp_residential_savings_factor', period),
                        buildings('ESS_HEER_lighting_replace_PAR_lamp_small_business_savings_factor', period),
                        0
                ]
                )
...
class ESS_HEER_lighting_replace_PAR_lamp_residential_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class ESS_HEER_lighting_replace_PAR_lamp_small_business_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    label = 'Returns the relevant savings factor for the existing and new lamp' \
