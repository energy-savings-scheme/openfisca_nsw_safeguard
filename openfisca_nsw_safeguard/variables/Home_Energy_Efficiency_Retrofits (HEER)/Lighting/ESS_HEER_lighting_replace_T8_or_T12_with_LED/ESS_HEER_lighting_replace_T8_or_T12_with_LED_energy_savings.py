...
class ESS_HEER_lighting_replace_T8_or_T12_with_LED_residential_savings_factor(BaseVariable):
    value_type = float
    entity = Building
...
class ESS_HEER_lighting_replace_T8_or_T12_with_LED_small_business_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    label = 'Returns the relevant savings factor for the existing and new lamp' \
