...
class ESS_HEER_modify_external_window_with_draught_proofing_windows_have_gaps_between_door_and_frame(BaseVariable):
    value_type = bool
    entity = Building
...
class ESS_HEER_modify_external_window_with_draught_proofing_window_is_external(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
...
class ESS_HEER_modify_external_window_with_draught_proofing_meets_eligibility_requirements(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
