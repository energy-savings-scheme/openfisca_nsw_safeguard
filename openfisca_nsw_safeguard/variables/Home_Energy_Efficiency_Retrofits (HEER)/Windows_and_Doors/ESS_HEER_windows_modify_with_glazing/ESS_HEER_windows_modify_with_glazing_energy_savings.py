...
class ESS_HEER_windows_modify_with_glazing_residential_electricity_savings_factor(BaseVariable):
    value_type = float
    entity = Building
...
class ESS_HEER_windows_modify_with_glazing_residential_gas_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
...
class ESS_HEER_windows_modify_with_glazing_small_business_electricity_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    label = 'Returns the residential electricity savings factor for the' \
...
class ESS_HEER_windows_modify_with_glazing_small_business_gas_savings_factor(BaseVariable):
    value_type = float
    entity = Building
    definition_period = ETERNITY
    label = 'Returns the residential gas savings factor for the' \
