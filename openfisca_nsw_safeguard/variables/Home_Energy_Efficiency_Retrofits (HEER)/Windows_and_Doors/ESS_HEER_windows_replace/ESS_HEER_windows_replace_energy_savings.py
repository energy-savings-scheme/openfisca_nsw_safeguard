...
class ESS_HEER_windows_replace_residential_electricity_savings_factor(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        ESS.HEER.table_D1_2[U_value_rating][activity_climate_zone])
...
class ESS_HEER_windows_replace_residential_gas_savings_factor(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        ESS.HEER.table_D1_3.residential_gas_savings_factor[U_value_rating][activity_climate_zone])
...
class ESS_HEER_windows_replace_small_business_electricity_savings_factor(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        ESS.HEER.table_D1_4.small_business_electricity_savings_factor[U_value_rating][activity_climate_zone])
...
class ESS_HEER_windows_replace_small_business_gas_savings_factor(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        ESS.HEER.table_D1_5.small_business_gas_savings_factor[U_value_rating][activity_climate_zone])
