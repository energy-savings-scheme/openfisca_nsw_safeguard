...
class PDRS_HEAB_residential_AC_replace_meets_implementation_requirements(Variable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class PDRS_HEAB_residential_AC_replace_meets_all_requirements(Variable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
    ...
    def formula(buildings, period, parameters):
        eligibility = buildings(
            'PDRS_HEAB_residential_AC_replace_meets_eligibility_requirements', period)
        equipment = buildings(
            'PDRS_HEAB_residential_AC_replace_meets_equipment_requirements', period)
        implementation = buildings(
            'PDRS_HEAB_residential_AC_replace_meets_implementation_requirements', period)
