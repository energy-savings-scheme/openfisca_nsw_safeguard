...
class PDRS_HVAC_1_peak_demand_saving_capacity(Variable):
    ...
    def formula(buildings, period, parameters):
        baseline_power_input = buildings(
            'PDRS_HVAC_1_baseline_input_power', period)
...
class PDRS_HVAC_1_baseline_AEER(Variable):
    ...
    def formula(buildings, period, parameters):
        ...
        baseline_AEER = np.select([
                                    ...
                                    [
                                        parameters(period).PDRS.AC.table_HVAC_1_1[product_class][cooling_capacity],
                                        parameters(period).PDRS.AC.table_HVAC_1_2[product_class][cooling_capacity]
                                    ])
