...
class PDRS_HVAC_1_install_meets_eligibility_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = True
...
class PDRS_HVAC_1_install_meets_equipment_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class PDRS_HVAC_1_install_meets_implementation_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class PDRS_HVAC_1_install_meets_all_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
