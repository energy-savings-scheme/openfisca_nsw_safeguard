...
class PDRS_HVAC_2_peak_demand_saving_capacity(BaseVariable):
    entity = Building
    value_type = float
...
class PDRS_HVAC_2_baseline_input_power(BaseVariable):
    value_type = float
    entity = Building
...
class PDRS_HVAC_2_baseline_AEER(BaseVariable):
    value_type = float
    entity = Building
...
class PDRS_HVAC_2_TCSPF_or_AEER_exceeds_benchmark(BaseVariable):
    value_type = bool
    entity = Building
    definition_period = ETERNITY
