...
class ESS_ROOA_remove_primary_refrigerator_meets_equipment_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
...
class ESS_ROOA_remove_primary_refrigerator_meets_all_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
...
class ESS_ROOA_remove_primary_refrigerator_new_fridge_is_delivered(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
