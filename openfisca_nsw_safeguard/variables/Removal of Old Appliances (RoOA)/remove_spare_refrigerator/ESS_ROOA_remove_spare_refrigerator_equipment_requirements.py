...
class ESS_ROOA_remove_spare_refrigerator_meets_equipment_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
...
class ESS_ROOA_remove_spare_refrigerator_meets_all_requirements(BaseVariable):
    value_type = bool
    entity = Building
    default_value = False
    definition_period = ETERNITY
